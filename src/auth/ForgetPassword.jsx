  ...
  return (
    <section className="h-[calc(100vh-70px)] w-[100%] bg-slate-900  flex justify-center items-center  ">
          <div className="  w-[30%] bg bg-slate-700 rounded-lg">
            <header>
              <h1 className="text-center text-3xl p-2"> Reset password</h1>
            </header>
            <main className="p-2">
              ...
              <NavLink to="/auth/login" className="w-[100%] bg-red-600 block py-2 rounded-lg font-semibold hover:bg-red-700">
                cancel
              </NavLink>
            </div>
                </form>
